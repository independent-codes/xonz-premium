...
TIMES="10"
CHATID="1033507217"
KEY="7177072172:AAGO2TdvhPy_JS85xheW4dTo8pgPAO4pY8E"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m          WELCOME TO XonZ-VPN BY REVOLT            \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/independent-codes/izin/main/ip"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/independent-codes/xonz-premium/main/"
start=$(date +%s)
secs_to_human() {
...
if [[ -z "$nama" ]]; then
  echo "XonZ-VPN" > /etc/xray/username
else
...
wget raw.githubusercontent.com/independent-codes/xonz-premium/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
